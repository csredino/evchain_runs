...
map_n1n1 = 
    HM.fromList [ (Nothing       , MGProc [] [ "p p > n1 n1 " ])
                , (Just (3,1000022,[]) , MGProc [] [ "n1 > ax j j  " ] ) 
		, (Just (4,1000022,[]) , MGProc [] [ "n1 > ax j j  " ] )
                ] 
...
pdir :: ProcDir
pdir = ProcDir { pdWorkDirPrefix = "Axino_2jet" 
               , pdRemoteDirBase = "Axino_2jet"
               , pdRemoteDirPrefix = "Axino_2jet" }
