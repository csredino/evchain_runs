...
p_neut :: DDecay
p_neut = d (neut, [t nu, t jets, t jets])
...
map_n1n1 = 
    HM.fromList [ (Nothing       , MGProc [] [ "p p > n1 n1 " ])
                , (Just (3,1000022,[]) , MGProc [] [ "n1 > nu j j  " ] ) 
		, (Just (4,1000022,[]) , MGProc [] [ "n1 > nu j j  " ] )
                ] 
...
pdir :: ProcDir
pdir = ProcDir { pdWorkDirPrefix = "rpv_2jet" 
               , pdRemoteDirBase = "rpv_2jet"
               , pdRemoteDirPrefix = "rpv_2jet" }
