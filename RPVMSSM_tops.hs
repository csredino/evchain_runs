...
p_neut :: DDecay
p_neut = d (neut, [t vl, t top, t antitop, t jets])
...
map_n1n1 = 
    HM.fromList [ (Nothing       , MGProc [] [ "p p > n1 n1 " ])
                , (Just (3,1000022,[]) , MGProc [] [ "n1 > vl t t~ j  " ] ) 
		, (Just (4,1000022,[]) , MGProc [] [ "n1 > vl t t~ j  " ] )
                ] 
...
pdir :: ProcDir
pdir = ProcDir { pdWorkDirPrefix = "RPVMSSM_tops" 
               , pdRemoteDirBase = "RPVMSSM_tops"
               , pdRemoteDirPrefix = "RPVMSSM_tops" }
