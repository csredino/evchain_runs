...
p_neut :: DDecay
p_neut = d (neut, [t axino, t jets, t jets, t jets])
...
map_n1n1 = 
    HM.fromList [ (Nothing       , MGProc [] [ "p p > n1 n1 " ])
                , (Just (3,1000022,[]) , MGProc [] [ "n1 > ax j j j  " ] ) 
		, (Just (4,1000022,[]) , MGProc [] [ "n1 > ax j j j  " ] )
                ] 
...
pdir :: ProcDir
pdir = ProcDir { pdWorkDirPrefix = "Axino_massless" 
               , pdRemoteDirBase = "Axino_massless"
               , pdRemoteDirPrefix = "Axino_massless" }
