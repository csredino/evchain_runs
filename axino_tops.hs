...
p_neut :: DDecay
p_neut = d (neut, [t axino, t top, t antitop, t jets])
...
map_n1n1 = 
    HM.fromList [ (Nothing       , MGProc [] [ "p p > n1 n1 " ])
                , (Just (3,1000022,[]) , MGProc [] [ "n1 > ax t t~ j  " ] ) 
		, (Just (4,1000022,[]) , MGProc [] [ "n1 > ax t t~ j  " ] )
                ] 
...
pdir :: ProcDir
pdir = ProcDir { pdWorkDirPrefix = "Axino_tops" 
               , pdRemoteDirBase = "Axino_tops"
               , pdRemoteDirPrefix = "Axino_tops" }
